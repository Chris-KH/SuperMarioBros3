...
void Menu::run() {
    ...
    Level level1("../assets/Map/Map1-1.txt", "../assets/Map/map1-1.png", "../assets/Sound/World1.mp3","1-1");
    Level level2("../assets/Map/Map1-2.txt", "../assets/Map/map1-2.png", "../assets/Sound/World4.mp3","1-2");
    Level level3("../assets/Map/Map1-3.txt", "../assets/Map/map1-3.png", "../assets/Sound/World5.mp3","1-3");
    Level level4("../assets/Map/Map1-4.txt", "../assets/Map/map1-4.png", "../assets/Sound/Athletic.mp3", "1-4");
