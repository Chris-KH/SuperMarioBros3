...
void FireStarmanState::setAnimation() {
    ...
    if (character->getCharacterType() == MARIO) {
        character->idleLeft = RESOURCE_MANAGER.getAnimation("mario1.txt/firestarmario_idle_left");
        character->walkLeft = RESOURCE_MANAGER.getAnimation("mario1.txt/firestarmario_walk_left");
        character->runLeft = RESOURCE_MANAGER.getAnimation("amario1.txt/firestarmario_run_left");
        character->stopLeft = RESOURCE_MANAGER.getAnimation("mario1.txt/firestarmario_stop_left");
        character->jumpLeft = RESOURCE_MANAGER.getAnimation("mario1.txt/firestarmario_jump_left");
        character->fallLeft = RESOURCE_MANAGER.getAnimation("mario1.txt/firestarmario_fall_left");
        character->flyLeft = RESOURCE_MANAGER.getAnimation("mario1.txt/firestarmario_fly_left");
        character->sitLeft = RESOURCE_MANAGER.getAnimation("mario1.txt/firestarmario_sit_left");
        character->holdLeft = RESOURCE_MANAGER.getAnimation("mario1.txt/firestarmario_hold_left");
        character->throwLeft = RESOURCE_MANAGER.getAnimation("mario1.txt/firestarmario_throw_left");

        character->idleRight = RESOURCE_MANAGER.getAnimation("mario1.txt/firestarmario_idle_right");
        character->walkRight = RESOURCE_MANAGER.getAnimation("mario1.txt/firestarmario_walk_right");
        character->runRight = RESOURCE_MANAGER.getAnimation("mario1.txt/firestarmario_run_right");
        character->stopRight = RESOURCE_MANAGER.getAnimation("mario1.txt/firestarmario_stop_right");
        character->jumpRight = RESOURCE_MANAGER.getAnimation("mario1.txt/firestarmario_jump_right");
        character->fallRight = RESOURCE_MANAGER.getAnimation("mario1.txt/firestarmario_fall_right");
        character->flyRight = RESOURCE_MANAGER.getAnimation("mario1.txt/firestarmario_fly_right");
        character->sitRight = RESOURCE_MANAGER.getAnimation("mario1.txt/firestarmario_sit_right");
        character->holdRight = RESOURCE_MANAGER.getAnimation("mario1.txt/firestarmario_hold_right");
        character->throwRight = RESOURCE_MANAGER.getAnimation("mario1.txt/firestarmario_throw_right");
    }
    else if (character->getCharacterType() == LUIGI) {
        character->idleLeft = RESOURCE_MANAGER.getAnimation("luigi1.txt/firestarluigi_idle_left");
        character->walkLeft = RESOURCE_MANAGER.getAnimation("luigi1.txt/firestarluigi_walk_left");
        character->runLeft = RESOURCE_MANAGER.getAnimation("luigi1.txt/firestarluigi_run_left");
        character->stopLeft = RESOURCE_MANAGER.getAnimation("luigi1.txt/firestarluigi_stop_left");
        character->jumpLeft = RESOURCE_MANAGER.getAnimation("luigi1.txt/firestarluigi_jump_left");
        character->fallLeft = RESOURCE_MANAGER.getAnimation("luigi1.txt/firestarluigi_fall_left");
        character->flyLeft = RESOURCE_MANAGER.getAnimation("luigi1.txt/firestarluigi_fly_left");
        character->sitLeft = RESOURCE_MANAGER.getAnimation("luigi1.txt/firestarluigi_sit_left");
        character->holdLeft = RESOURCE_MANAGER.getAnimation("luigi1.txt/firestarluigi_hold_left");
        character->throwLeft = RESOURCE_MANAGER.getAnimation("luigi1.txt/firestarluigi_throw_left");

        character->idleRight = RESOURCE_MANAGER.getAnimation("luigi1.txt/firestarluigi_idle_right");
        character->walkRight = RESOURCE_MANAGER.getAnimation("luigi1.txt/firestarluigi_walk_right");
        character->runRight = RESOURCE_MANAGER.getAnimation("luigi1.txt/firestarluigi_run_right");
        character->stopRight = RESOURCE_MANAGER.getAnimation("luigi1.txt/firestarluigi_stop_right");
        character->jumpRight = RESOURCE_MANAGER.getAnimation("luigi1.txt/firestarluigi_jump_right");
        character->fallRight = RESOURCE_MANAGER.getAnimation("luigi1.txt/firestarluigi_fall_right");
        character->flyRight = RESOURCE_MANAGER.getAnimation("luigi1.txt/firestarluigi_fly_right");
        character->sitRight = RESOURCE_MANAGER.getAnimation("luigi1.txt/firestarluigi_sit_right");
        character->holdRight = RESOURCE_MANAGER.getAnimation("luigi1.txt/firestarluigi_hold_right");
        character->throwRight = RESOURCE_MANAGER.getAnimation("luigi1.txt/firestarluigi_throw_right");
    }
