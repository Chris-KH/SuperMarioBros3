...
void SuperState::setAnimation() {
    ...
    if (character->getCharacterType() == MARIO) {
        character->idleLeft = RESOURCE_MANAGER.getAnimation("mario1.txt/supermario_idle_left");
        character->walkLeft = RESOURCE_MANAGER.getAnimation("mario1.txt/supermario_walk_left");
        character->runLeft = RESOURCE_MANAGER.getAnimation("mario1.txt/supermario_run_left");
        character->stopLeft = RESOURCE_MANAGER.getAnimation("mario1.txt/supermario_stop_left");
        character->jumpLeft = RESOURCE_MANAGER.getAnimation("mario1.txt/supermario_jump_left");
        character->fallLeft = RESOURCE_MANAGER.getAnimation("mario1.txt/supermario_fall_left");
        character->flyLeft = RESOURCE_MANAGER.getAnimation("mario1.txt/supermario_fly_left");
        character->sitLeft = RESOURCE_MANAGER.getAnimation("mario1.txt/supermario_sit_left");
		character->holdLeft = RESOURCE_MANAGER.getAnimation("mario1.txt/supermario_hold_left");
		character->kickLeft = RESOURCE_MANAGER.getAnimation("mario1.txt/supermario_kick_left");

        character->idleRight = RESOURCE_MANAGER.getAnimation("mario1.txt/supermario_idle_right");
        character->walkRight = RESOURCE_MANAGER.getAnimation("mario1.txt/supermario_walk_right");
        character->runRight = RESOURCE_MANAGER.getAnimation("mario1.txt/supermario_run_right");
        character->stopRight = RESOURCE_MANAGER.getAnimation("mario1.txt/supermario_stop_right");
        character->jumpRight = RESOURCE_MANAGER.getAnimation("mario1.txt/supermario_jump_right");
        character->fallRight = RESOURCE_MANAGER.getAnimation("mario1.txt/supermario_fall_right");
        character->flyRight = RESOURCE_MANAGER.getAnimation("mario1.txt/supermario_fly_right");
        character->sitRight = RESOURCE_MANAGER.getAnimation("mario1.txt/supermario_sit_right");
		character->holdRight = RESOURCE_MANAGER.getAnimation("mario1.txt/supermario_hold_right");
		character->kickRight = RESOURCE_MANAGER.getAnimation("mario1.txt/supermario_kick_right");
    }
    else if (character->getCharacterType() == LUIGI) {
        character->idleLeft = RESOURCE_MANAGER.getAnimation("luigi1.txt/superluigi_idle_left");
        character->walkLeft = RESOURCE_MANAGER.getAnimation("luigi1.txt/superluigi_walk_left");
        character->runLeft = RESOURCE_MANAGER.getAnimation("luigi1.txt/superluigi_run_left");
        character->stopLeft = RESOURCE_MANAGER.getAnimation("luigi1.txt/superluigi_stop_left");
        character->jumpLeft = RESOURCE_MANAGER.getAnimation("luigi1.txt/superluigi_jump_left");
        character->fallLeft = RESOURCE_MANAGER.getAnimation("luigi1.txt/superluigi_fall_left");
        character->flyLeft = RESOURCE_MANAGER.getAnimation("luigi1.txt/superluigi_fly_left");
        character->sitLeft = RESOURCE_MANAGER.getAnimation("luigi1.txt/superluigi_sit_left");
		character->holdLeft = RESOURCE_MANAGER.getAnimation("luigi1.txt/superluigi_hold_left");
        character->kickLeft = RESOURCE_MANAGER.getAnimation("luigi1.txt/superluigi_kick_left");

        character->idleRight = RESOURCE_MANAGER.getAnimation("luigi1.txt/superluigi_idle_right");
        character->walkRight = RESOURCE_MANAGER.getAnimation("luigi1.txt/superluigi_walk_right");
        character->runRight = RESOURCE_MANAGER.getAnimation("luigi1.txt/superluigi_run_right");
        character->stopRight = RESOURCE_MANAGER.getAnimation("luigi1.txt/superluigi_stop_right");
        character->jumpRight = RESOURCE_MANAGER.getAnimation("luigi1.txt/superluigi_jump_right");
        character->fallRight = RESOURCE_MANAGER.getAnimation("luigi1.txt/superluigi_fall_right");
        character->flyRight = RESOURCE_MANAGER.getAnimation("luigi1.txt/superluigi_fly_right");
        character->sitRight = RESOURCE_MANAGER.getAnimation("luigi1.txt/superluigi_sit_right");
        character->holdRight = RESOURCE_MANAGER.getAnimation("luigi1.txt/superluigi_hold_right");
        character->kickRight = RESOURCE_MANAGER.getAnimation("luigi1.txt/superluigi_kick_right");
    }
